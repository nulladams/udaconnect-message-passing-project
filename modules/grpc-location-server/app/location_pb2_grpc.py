...
class TestServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                '/TestService/Get',
                request_serializer=location__pb2.TestMessage.SerializeToString,
                response_deserializer=location__pb2.TestMessage.FromString,
                )
...
def add_TestServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=location__pb2.TestMessage.FromString,
                    response_serializer=location__pb2.TestMessage.SerializeToString,
            ),
    }
...
class TestService(object):
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/TestService/Get',
            location__pb2.TestMessage.SerializeToString,
            location__pb2.TestMessage.FromString,
